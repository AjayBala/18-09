...
import CorporationForm, {
    validate, FieldFileInput, Corporation, renderDropDown,
} from './Corporation';
...
describe('Test suits for <Corporation />', () => {
    ...
    beforeEach(() => {
        ...
        const store = mockStore({
            ...
            login: { userValues: { email: 'Overstock@gmail.com', password: 'Overstock18' } }
        });
        ...
        component = mount(
            <Provider store={store}>
                <CorporationForm submitCase={handleSubmit}/>
            </Provider>,
        );
    });
    ...
    it('should be categorys', () => {
        wrapperRedComp.find('.categorys').simulate('change', { event: { target: { value: 'Real Estate' } } });
    });
});
