...
import {
    ...
    ProfessionalBenefits, whyOprofesional,
    minimumSpendingRequirement,
    govtRequirement, smallBusinessPoints
                ...
                <Grid>
                        ...
                        <Row>
                            ...
                            <Col sm={12} md={5}>
                                <div className="ProfBenefitsPoints">
                                    ...
                                    <ul>
                                        {ProfessionalBenefits && ProfessionalBenefits.map(benefit => <li key={benefit.id}>{benefit.value}</li>)}
                                    </ul>
                                </div>
                            </Col>
                            <Col sm={12} md={7}>
                            ...
                            <Col sm={12} md={5}>
                                <div className="ProfBenefitsPoints">
                                    ...
                                    <ul className="videoBoxList listStyleNone">
                                        {whyOprofesional && whyOprofesional.map(Obj => <li key={Obj.id}><p>{Obj.value}</p></li>)}
                                    </ul>
                                </div>
                            </Col>
                            <Col sm={12} md={7}>
                    ...
                    <section className="ProfBenefitsBase" id="designer">
                        <Row>
                            <Col md={12}>
                                ...
                                <p className="paragraph_Txt">{governmentBuyersText}</p>
                            </Col>
                            <Grid>
                                <Row>
                                    <Col sm={12}>
                        ...
                        <Row>
                            ...
                            <Col md={6} sm={12}>
                                <ol className="listtype">
                                    ...
                                    {minimumSpendingRequirement && minimumSpendingRequirement.map(Obj => <li className="spacePoints" key={Obj.id}>{Obj.value}</li>)}
                                </ol>
                            </Col>
                            <Col md={6} sm={12}>
                                <ol className="listtype">
                                    ...
                                    {govtRequirement && govtRequirement.map(Obj => <li key={Obj.id}>{Obj.value}</li>)}
                                </ol>
                            </Col>
                            <Col sm={12}>
                    ...
                    <section className="ProfBenefitsBase" id="business">
                        <Row>
                            ...
                            <Grid>
                                <Row>
                                    {smallBusinessPoints && smallBusinessPoints.map(Obj => (
